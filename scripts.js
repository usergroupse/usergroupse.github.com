...
var payedEvents='<iframe src="https://www.google.com/calendar/embed?src=ifskb2drnv82aq36mjt0ho2cp0%40group.calendar.google.com&ctz=Europe/Stockholm" style="border: 0" width="100%" height="600" frameborder="0" scrolling="no"></iframe>';
...
$(document).ready(function() {
  $("input").click(function() {
    ...
    }   else if($("input[id=payed]:checked").length==1) {
      console.log("payed")
